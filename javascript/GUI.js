...
export default function startGUI (webGLContext) {
  ...
  gui.add(config, 'DYE_RESOLUTION', { high: 1024, medium: 512, low: 256, 'very low': 128 ,'potatoes': 512}).name('Qualité').onFinishChange(() => initFramebuffers(webGLContext))
  gui.add(config, 'SIM_RESOLUTION', { 'high': 1024, 32: 32, 64: 64, 128: 128, 256: 256 }).name('Résolution').onFinishChange(() => initFramebuffers(webGLContext))
